...
link:/attachments/25_texture_mapping.cpp[Code C{pp}] / link:/attachments/25_shader_textures.vert[Vertex shader] / link:/attachments/25_shader_textures.frag[Fragment shader]
