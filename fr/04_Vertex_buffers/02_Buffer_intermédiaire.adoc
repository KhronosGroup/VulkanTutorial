...
link:/attachments/19_staging_buffer.cpp[Code C{pp}] / link:/attachments/17_shader_vertexbuffer.vert[Vertex shader] / link:/attachments/17_shader_vertexbuffer.frag[Fragment shader]
