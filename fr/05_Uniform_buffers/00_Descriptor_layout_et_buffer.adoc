...
link:/attachments/21_descriptor_layout.cpp[Code C{pp}] / link:/attachments/21_shader_ubo.vert[Vertex shader] / link:/attachments/21_shader_ubo.frag[Fragment shader]
