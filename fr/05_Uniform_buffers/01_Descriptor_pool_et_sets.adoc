...
link:/attachments/22_descriptor_sets.cpp[Code C{pp}] / link:/attachments/21_shader_ubo.vert[Vertex shader] / link:/attachments/21_shader_ubo.frag[Fragment shader]
