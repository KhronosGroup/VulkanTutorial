...
Now that we have the skeleton for the Vulkan application, let's link:!en/Drawing_a_triangle/Setup/Instance[create the first Vulkan object]!

link:/code/00_base_code.cpp[C{pp} code]
