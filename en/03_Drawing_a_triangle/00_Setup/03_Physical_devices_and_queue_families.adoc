...
The next step is to link:!en/Drawing_a_triangle/Setup/Logical_device_and_queues[create a logical device] to interface with it.

link:/code/03_physical_device_selection.cpp[C{pp} code]
