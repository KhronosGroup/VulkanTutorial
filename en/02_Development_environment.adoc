...
See the link:!en/Introduction[introduction chapter] for links to drivers from the major vendors.
...
We'll cover this in depth in the link:!en/Drawing_a_triangle/Graphics_pipeline_basics/Shader_modules[shader modules] chapter.
...
Congratulations, you're all set for link:!en/Drawing_a_triangle/Setup/Base_code[playing with Vulkan]!
...
We'll cover `glslc` in depth in the link:!en/Drawing_a_triangle/Graphics_pipeline_basics/Shader_modules[shader modules] chapter.
...
You are now all set for link:!en/Drawing_a_triangle/Setup/Base_code[the real adventure].
...
You are now all set for link:!en/Drawing_a_triangle/Setup/Base_code[the real thing].
